...
namespace SGM.Saude.API.Extensions
{
    ...
    {
        public static string Name => "SGM.Saude";
        public static string Description => "SGM Saude - API de Gerenciamento de Consultas e Funcionarios Medicos e Clinicas no portal.";

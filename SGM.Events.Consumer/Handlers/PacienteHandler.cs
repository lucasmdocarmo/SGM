...
{
    public class PacienteHandler : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            {
                GroupId = "paciente-topic-consumer",
            ...
            while (!cancellationToken.IsCancellationRequested)
            {
                ...
                consumer.Subscribe("paciente-topic");
                ...
                try
                {
                    while (true)
                    {
                        ...
                        ReplicarPaciente(message.Value);
                    }
                }
        ...
        private void ReplicarPaciente(string request)
        {
